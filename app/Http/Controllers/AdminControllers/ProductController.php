...
class ProductController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        // if(isset($request->categories) and count){            
            ...
            $attribute_ids = $request->choice_attributes;
        ...
        $result = array_merge_recursive(
            array_combine($keys, $attribute_ids),
            array_combine($keys, $choices),
            array_combine($keys, $quantities),
            array_combine($keys, $prices)
        );
        ...
        foreach ($result as $value) {
            ...
            $attribute->product_id = $products_id;
            $attribute->attribute_id = $attribute_id;
            $attribute->choice_option = $choice;
