                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/products/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'choice_form', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                ...
                                                <div class="special-container" style="display: none;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            <input class="form-control datepicker" readonly type="text" name="expires_date" id="expiry-date" value="">
                                                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <select name="choice_attributes[]" id="choice_attributes" class="form-control select2" data-placeholder="Choose Attributes">
                                                            @foreach (\App\Models\Core\Attribute::all() as $key => $attribute)
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" name="choice[]" class="form-control m-input" placeholder="Enter your choice" autocomplete="off">
                                                    </div>
                                                ...
                                                <button id="addRow" type="button" style="" class="btn btn-sm btn-info"><b style="font-size: 14px;">+</b></button>

                                                
                                                  <button id="removeRow" type="button" class="btn btn-sm btn-info ml-1" style=""><b style="font-size: 14px;">-</b></button>
                                                </div>
...
<script src="{{ asset('admin/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js.map')}}"></script>
<script type="text/javascript">

    function get_att(size){
        var name = size;
    }
    ...
    $("#addRow").click(function () {
        ...
        html += '<div class="row ml-0" style="margin-top: 10px; margin-bottom: 10px;" id="childRow">';
        html += '<div class="col-sm-3">';
        html += '<select name="choice_attributes[]" id="choice_attributes" class="form-control select2" data-placeholder="Choose Attributes">@foreach (\App\Models\Core\Attribute::all() as $key => $attribute)';
        html += '<option value="{{ $attribute->id }}">{{ $attribute->name }}</option>';
        html += '@endforeach</select>';
        html += '</div>';
        html += '<div class="col-sm-3">'
        html += '<input type="text" name="choice[]" class="form-control ml-0" placeholder="Enter your choice" autocomplete="off">';
        html += '</div>';
        html += '<div class="col-sm-3">';
        html += '<input type="text" name="quantity[]" class="form-control ml-0" placeholder="Enter quantity" autocomplete="off">';
        html += '</div>';
        html += '<div class="col-sm-3">'
        html += '<input type="text" name="price[]" class="form-control ml-0" placeholder="Enter price" autocomplete="off">';
        html += '</div>';
