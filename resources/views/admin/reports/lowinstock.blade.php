                 ...
                 @if(count($result['lowQunatity']) > 0)
                    @foreach ($result['lowQunatity'] as  $key=>$lowQunatityProducts)
                        <tr>
                            ...
                            <?php                             
                              $image = DB::table('image_categories')
                                    ->where('image_categories.image_id',$lowQunatityProducts->products_image)
                            ...
                            <td><img src="{{asset('').$image->path}}" alt="" width=" 100px" height="100px"></td>
