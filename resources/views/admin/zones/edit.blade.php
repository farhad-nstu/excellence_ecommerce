                                    ...
                                    <div class="box box-info"><br>
                                      ...
                                      @endif
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Shipping Price
                                                </label>
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('shipping_price', $result['zones']->shipping_price, array('class'=>'form-control field-validate', 'id'=>'shipping_price'))!!}
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.ZoneNameText') }}</span>
                                                    <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                                </div>
                                            </div>
