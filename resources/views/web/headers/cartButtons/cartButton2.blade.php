    ...
    <ul class="shopping-cart-items">
        ...
        <li>
            ...
            <div class="item-detail">
              ...
              <div class="item-s">{{Session::get('symbol_left')}}{{$result['commonContent']['cart'][0]->final_price*session('currency_value')}}{{Session::get('symbol_right')}}
                <a href="{{ URL::to('/deleteCart?id='.$cart_data->customers_basket_id)}}"><i class="fas fa-trash"></i></a></div>
           </div>
        </li>
        <!-- @endforeach -->
        <li>
            <span class="item-summary">@lang('website.SubTotal')&nbsp;:&nbsp;<span>{{Session::get('symbol_left')}}{{ $result['commonContent']['cart'][0]->final_price*session('currency_value') }}{{Session::get('symbol_right')}}</span>
            </span>
        </li>
