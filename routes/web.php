...
Route::group(['namespace' => 'Web','middleware' => $middleware], function () {
	...
	// route for to show payment form using get method 
		...
		Route::post('web/increase', 'CartController@increase_qty');
		Route::post('web/decrease', 'CartController@decrease_qty');
		Route::get('web/shipping/price/{id}', 'OrdersController@get_shipping_price');
		Route::get('web/shipping/store', 'OrdersController@set_price_to_session');
		// Route::get('web/shipping/session/destroy', 'OrdersController@destroy_session');
		Route::get('web/cartPrice/store', 'OrdersController@set_cart_price_to_session');
		/// end ////
		...
		Route::get('/shurjo_pay_store/{price}', 'OrdersController@shurjoPayStore')->name('shurjo_pay_store');
		Route::get('/shurjoPayCallback', 'OrdersController@shurjoPayCallback')->name('shurjoPayCallback');
